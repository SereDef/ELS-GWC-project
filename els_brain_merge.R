...
# Filter participants 
els_brain_sample <- filter(output, mri_consent_f09 == "yes" & t1_has_nii_f09 == "yes" & t1_asset_has_nii_f09 != "exclude" & has_braces_mri_f09 == "no" & exclude_incidental_f09 == "include" & freesurfer_qc_f09 == "usable" & qdec_has_lgi_f09 == "yes" & twin == 0 & !IDC %in% sibs_to_include & pre_percent_missing < 50 & post_percent_missing < 50 & !is.na(age_child_mri_f09 == "TRUE") & !is.na(ethn_cont == "TRUE"))
